...
public abstract class GuiButton extends GuiElement
{
	...
	public static class GuiButtonRadiobox extends GuiButton
	{
		...
		public GuiButtonRadiobox(int x, int y, int width, int height)
		{
			...
			textureActive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonRadioboxActive.png");
			textureInactive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonRadioboxInactive.png");
			textureHoverActive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonRadioboxHoverActive.png");
			textureHoverInactive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonRadioboxHoverInactive.png");
		}
	...
	public static class GuiButtonCheckbox extends GuiButton
	{
		protected GuiButtonCheckbox(int x, int y, int width, int height)
		{
			...
			textureActive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonCheckboxActive.png");
			textureInactive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonCheckboxInactive.png");
			textureHoverActive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonCheckboxHoverActive.png");
			textureHoverInactive = new ResourceLocation(ModInfo.TEXTURE_PATH, "textures/guis/buttonCheckboxHoverInactive.png");
		}
